...
public class DoubleArraySequence {
    ...
    public DoubleArraySequence(DoubleArraySequence src) {
        ...
        double[] newArr = new double[src.getCapacity()];
    ...
    public void addAfter(double d) {
        ...
        if (isCurrent()) {
            ...
            for (int i = manyItems; i > manyItems + 1; i--) {
                data[i] = data[i - 1];
            }
            data[manyItems] = d;
            manyItems++;
    ...
    public static DoubleArraySequence catenation(DoubleArraySequence s1, DoubleArraySequence s2) {
        ...
        newSequence.setCurrentIndex(newSequence.manyItems);
        newSequence.ensureCapacity(s1.getCapacity());
        return newSequence;
    }
